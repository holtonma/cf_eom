...
<cfquery datasource="#sDSN2#" name="qGetAllEmailAddresses">
	...
	FROM tentrant
	WHERE emailaddy LIKE '%@%'
	AND (emailaddy LIKE '%.com' OR emailaddy LIKE '%.net' OR emailaddy LIKE '%.gov' OR emailaddy LIKE '%.ca'  OR emailaddy LIKE '%co.za')
...
<head>
       	...
       	<title>EyeOnMajors.com - Back again for the 2007 US Open!</title>
		<link rel="STYLESHEET" type="text/css" href="styles.css">
       	<style>
			.trborder {
				border-color: ##003300;
...
<div>EyeOnMajors.com is here again for the 9th year!  
	We are happy to provide this forum for your entertainment during the 2007 US Open. Just as you do, we love the great game of golf, and in particular, the majors. 
...
<cfelse>
	<div style="font-size:12px;">Once you login, you will be able to create a group!</div>
	  ...
	  <table width="800px" border="1" bordercolor="999999">
	    <tr>
	      <td width="500">
		      <img src="www.eyeonmajors.com/EyeOnMajors_USOpen.gif" alt="EyeOnMajors.com :: The Most Enjoyable Golf Pool on the Planet!" width="500" height="300"></td>
	      <td width="290">
