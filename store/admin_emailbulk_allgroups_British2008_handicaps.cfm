...
<cfoutput query="qEmails">
	<cfquery datasource="#sDSN2#" name="qGetGroup">
		...
		WHERE
			...
			AND
			tEG.eventid IN (7, 8, 9,10,11, 12, 13, 14)
	</cfquery>
...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qEmails.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="British Open 2008 : EyeOnMajors Handicaps" type="HTML">
...
The <b style="font-weight:bold;color:green;">2008 British Open</b> at Royal Birkdale is approximately 2 short days away!  </br></br>Listed below are the handicap and bonus selections for this year's US Open event on EyeOnMajors.com.  Good luck in selecting your squad this year, hope you and your group enjoy!
