...
<form action="groupleaderboard_manage.cfm" method="post">
  ...
  <div align="center" style="border:2px dotted green;padding:5px;font-size:20px;">EyeOnMajors Global Leaderboard</div>
		  ...
		  <cfoutput query="qAllTeamsGlobal">
			<cfif #qAllTeamsGlobal.entrantid# eq #SESSION.entrantid#>
		  	...
		  	<tr>
				...
				<!---  --->
				<cfif qATeamOfGolfers.RecordCount eq 6>
				...
				<cfelse>
					<td height="40" align="center" class="#classname#" colspan=6""><i>full squad not yet selected</i></td>
				</cfif>
