...
<cfsavecontent variable="yourteam">
	<ul style="text-align:left;list-style:none;">Your Team as of #DateFormat(Now(), "mm/dd/yyyy")# -- you can modify your team all the way prior to Round 1 of the Masters
