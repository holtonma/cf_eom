...
<form action="groupleaderboard_manage.cfm" method="post">
  <div class="leaderboardheader">
    <div align="center" style="border:4px solid green;padding:5px;font-size:20px;">GLOBAL LEADERBOARD</div>
		  ...
		  <cfoutput query="qAllTeamsGlobal">
			<cfif #qAllTeamsGlobal.entrantid# eq #SESSION.entrantid#>
		  	...
		  	<tr>
	            ...
	            <td height="40"  class="ltturq" align="center">
					<!--- <cfquery datasource="#sDSN#" name="qCheckForNoHandicaps" >
					  SELECT HandicapStrokes
					  FROM eomhandicaps
				  	...
				  	<cfquery datasource="#sDSN2#" name="qCheckForNoHandicaps" >
					  SELECT HandicapStrokes
					  FROM eomhandicaps
					  WHERE GolferID = #qAllTeamsGlobal.golfer1ID# OR GolferID = #qAllTeamsGlobal.golfer2ID# OR GolferID = #qAllTeamsGlobal.golfer3ID# OR GolferID = #qAllTeamsGlobal.golfer4ID# OR GolferID = #qAllTeamsGlobal.golfer5ID# OR GolferID = #qAllTeamsGlobal.golfer6ID#
				  	</cfquery> 
					...
					<cfif qCheckForNoHandicaps.RecordCount GT 0>
						<cfif #qHandicapSum.TotHndcpStrForEntrant# GT 0>
							+#qHandicapSum.TotHndcpStrForEntrant#
						<cfelseif #qHandicapSum.TotHndcpStrForEntrant# LT 0>
							#qHandicapSum.TotHndcpStrForEntrant#
				...
				<td height="40" class="largegrntxt" align="center">
				<!-- turn this into an array: array(i, NET, ID)? -->
				<cfif qCheckForNoHandicaps.RecordCount GT 0> <!-- this means there are handicaps to be added -->
				...
				<td height="40" class="largegrntxt" align="center">
					<!-- this is where the prize eligible goes... if groupID > 10-->
					<cfquery datasource="#sDSN#" name="qCheckEligible">
					...
					<cfif #qCheckEligible.numTeamsInGroup# GTE 10>
						<span class="coreboardeven" title="eligibility requires 10 full teams in group">YES!</span>
					<cfelse>
						<span class="coreboardover" title="eligibility requires 10 full teams in group">not<br>yet</span>
					</cfif>
				</td>
            </tr> --->
          </cfoutput>
