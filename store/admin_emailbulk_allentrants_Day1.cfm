...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qGetAllEmailAddresses.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="British Open : Day 1" type="HTML">
...
<div style="padding:10px;">Dear esteemed patron, #qGetAllEmailAddresses.fname# #qGetAllEmailAddresses.lname#: </div>
<div style="padding:10px;"> 
The 2007 British Open Championship is under way... 
</div>
<div style="padding:10px;">
	<div style="padding-top:5px;">
	For those of you who were baited into selecting the legend, Nick Faldo, our condolences.  &nbsp;&nbsp;
	The 20 shot 'bonus' seems like it will claim some more victims after Nick's stumble in round 1.  &nbsp;&nbsp;The 'major' players
	apparently have learned to take a careful look at those items that look too good to be true... 
	there's good reason it's known as 'the toughest golf pool on the planet'!
	</div>
	<div style="padding-top:8px;">
	The EyeOnMajors Committee is anticipating <strong>a comeback tomorrow for Justin Rose</strong>.  &nbsp;&nbsp;England's Rose was chosen by 34.6% of EyeOnMajors.com contestants) -- 
	but the main reason we anticipate a comeback is because both Committee members chose him. :)  &nbsp;&nbsp;Look for the cut to be around +3.  
	</div>
	<div style="padding-top:8px;">
	Next year we plan to have a message board where we can all debate these assertions, but until then, we get the last word. &nbsp;&nbsp;  Good luck and enjoy your pools this week-
	</div>  
	
	<div style="padding-top:10px;"><strong>Your logon information has been provided below for your 
