...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qEmails.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="The Masters 2008!" type="HTML">
...
After an exciting 2007, we are back for the first major of the year, the <b style="font-weight:bold;color:green;">2008 Masters</b> at Augusta National Golf Club!  We have continued to upgrade the site to version <b>2.0</b>. &nbsp;&nbsp;  Some of these features include

<ul style="text-align:left;">
	<li>Real-time LIVE scoring for your Groups!</li>
	<li>Real-time sidebar scoring for the Masters</li>
	<li>Faster site performance</li>
	<li>Improved Layout</li>
	<li>Easy to use Message Board</li>
	<li>more!</li>
</ul>
</div>
