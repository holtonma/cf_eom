...
<p class="message"><b>A Champion is Crowned:</b></p>

<p class="message">The <b style="font-weight:bold;color:green;">2008 Masters</b> has come to a close, and EyeOnMajors.com has found a clear-cut global champion, a winner by 9 shots with a winning NET score of +3 : Michael Bechert!  Congratulations, Michael, because your group had at least 5 participants with full squads you win the Golfap.com software, and the dozen golf balls of your choice!</p>

<p class="message">Thanks everyone for playing.  We hope you enjoyed the improvements in the site, and the real-time scoring.  We are looking forward to continuing the improvements through the US Open and beyond!</p>

<p class="message">See you at Torrey Pines-</p>
...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qEmails.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="Masters 2008 Global Champion : Michael Bechert!" type="HTML">
