...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qEmails.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="Update: Luke Donald is out." type="HTML">
...
Luke Donald will not be playing this year's PGA.  To avoid missing the cut, you'll want to replace him with a different player.  
</div>

<div style="padding:10px;" style="font-size:12px;">
	Alex Cejka and Peter McLachlin (Reno-Tahoe winner) are in.
</div>
