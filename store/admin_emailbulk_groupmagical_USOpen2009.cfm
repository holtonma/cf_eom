...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qEmails.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="Group 'Magical' - US Open #Year(Now())#" type="HTML">
...
Friends, we are back again, providing Major entertainment for your enjoyment. Join in our fun and get your picks in by Thursday a.m. at 1 a.m. PST.
</div>
