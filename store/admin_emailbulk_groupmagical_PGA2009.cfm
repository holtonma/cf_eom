...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qEmails.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="Group 'Magical' - PGA #Year(Now())#" type="HTML">
...
Friends, we are back again, providing Major entertainment for your enjoyment. Join in our fun and get your picks in by Thursday 1 a.m. PST.
</div>

<div style="padding:10px;">
Congrats to Wally Holton for his winner-take-all British Open victory!  Looking forward to more excitement the last major of the year!
</div>
