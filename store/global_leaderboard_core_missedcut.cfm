...
<form action="groupleaderboard_manage.cfm" method="post">
  <div class="worldrankingblack">
    <div align="center">2006 Open Championship :: Missed Cut "<cfoutput>#qSpecificGroupID.PoolGroupName#</cfoutput>".  Choose wisely in the next EyeOnMajors.com tourney, PGA Championship 2006. <br> </div>
  </div> 
  <cfset ccutline = 0/>  <!-- 8 was the cutline of the last major: US Open 2005, Pinehurst-->
  <cfif #ccutline# EQ 0>
	 <cfset strCutline = "E" />
