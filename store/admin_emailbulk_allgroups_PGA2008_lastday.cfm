...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qEmails.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="Reminder: last day for PGA entries" type="HTML">
...
Reminder: Wednesday is the last day to make your picks for the 2008 PGA Championship.  Entries close on Thursday at 2 a.m. PST.  Best of luck this week and enjoy~
</div>

<div style="padding:10px;">
As you know, you can jostle your line up as much as you want prior to the Thurs a.m. deadline.  Your login and group information is shown below.
</div>
