...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="eyeonmajors@gmail.com" to="#qGetAllEmailAddresses.emailaddy#" 
			replyto="eyeonmajors@gmail.com" subject="British Open 2007 -- EyeOnMajors.com!" type="HTML">
...
<div style="padding:10px;">After a massacre in the US Open where we saw just one lone contestant out of thousands make the cut, we are back to give you another shot at mastering this difficult game.  
	We hope you, your friends and co-workers continue to enjoy!  Your logon information has been provided below for your 
	convenience.  Good luck this week in your Group Pool and the Global Pool!
</div>
