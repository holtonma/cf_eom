...
<cfoutput query="qEmails">
	<cfquery datasource="#sDSN2#" name="qGetGroup">
		...
		WHERE
			...
			AND
			tEG.eventid IN (9,10,11, 12, 13, 14)
	</cfquery>
...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qEmails.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="The 2008 US Open!" type="HTML">
...
After an exciting Masters, we are back for the the <b style="font-weight:bold;color:green;">2008 US Open</b> at Torrey Pines!  &nbsp;&nbsp;Hope you and your group enjoy the additional US Open competitive action on EyeOnMajors.com the week of the tournament!  Make sure to get your team selections in, as there are just 3 short days left!  (deadline will be Thurs June 12th at 1 a.m. PST)
</div>

<div style="padding:10px;">As always it's 100% FREE.  Thanks for playing!</div>

<div align="center" style="color:gray;">For your easy reference, here is your login information:</div>
...
<div style="padding:10px;" align="center">
	...
	<img src="www.eyeonmajors.com/images/composite-placeholder_USOpen_new2_r1_c1_1.gif" border="0">
	</a>
</div>
