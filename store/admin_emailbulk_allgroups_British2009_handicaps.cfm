...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@gmail.com" to="#qEmails.emailaddy#" bcc="eyeonmajors@gmail.com"
			replyto="EyeOnMajors@gmail.com" subject="The British Open #Year(Now())# : Final Handicaps" type="HTML">
...
The <b style="font-weight:bold;color:green;">#Year(now())# British Open</b> at Turnberry is almost upon us.  </br></br>We heard your feedback to "keep it simple" and have limited the handicap system to one player -- all men are not created equal, Mr. Tiger Woods is worthy of a 10 shot handicap, otherwise it is too easy whether or not to select him.  Good luck in selecting your squad this event!

#handicaps#
</div>

<div style="padding:10px;">As always it's 100% FREE.  Thanks for playing and enjoy this great week!</div>
