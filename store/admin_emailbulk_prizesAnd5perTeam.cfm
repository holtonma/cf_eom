...
<cfif qGetGroup.RecordCount gt 0>
	...
	<cfmail from="EyeOnMajors@eyeonmajors.com" to="#qGetAllEmailAddresses.emailaddy#" 
			replyto="eyeonmajors@gmail.com" subject="EyeOnMajors.com Masters 2007 -- Prizes!" type="HTML">
...
a dozen (Titleist, Precept, or Callaway) premium golf balls of your choice, along with a copy of The Aviary game tracking software for the serious golfer -- a total value of over $115!
</div>
<div style="padding:10px;">
<cfset numSelectedGolfers = #qGetNumInGroup.NumInGroup#>
<cfset numMembers = Int(numSelectedGolfers / 6)>
<strong>Currently your group, "<span style="font-size:14px; color:green;">#qGetGroup.groupname#</span>", 
has 
<span style="font-size:14px; color:green;">#numMembers#</span> group members who have selected a full team of 6 golfers.</strong>
</div>
<div style="padding:10px;">
...
<cfelse>
	...
	You only need #numInvites# more member of your group to be eligible to compete for the Global Championship and the golf prizes!  
	What have you got to lose, it's FREE!  So invite #numInvites# more friends and you can all compete for the prizes! 
</cfif>
</div>
